"""
Nycto — SoundManager (модифицированный)
Добавлены атрибуты music_volume и sfx_volume для управления громкостью из меню.
"""
...
class SoundManager:
    def __init__(self):
        ...
        # --- начальная громкость ---
        self.sounds["jump"].set_volume(self.sfx_volume)
        for step in self.footsteps:
            step.set_volume(self.sfx_volume)
